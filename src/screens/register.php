                ...
                <form class="mt-8 grid grid-cols-2 gap-6" action="../controllers/registerController.php" method="post" enctype="multipart/form-data">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="FirstName"
                            name="first_name"
                            class="mt-1 w-full p-3 rounded-md border-gray-500 bg-white text-sm text-gray-700 shadow-md"
                        />
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input
                            ...
                            id="LastName"
                            name="last_name"
                            class="mt-1 w-full p-3  rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-md"
                        />
                    </div>
