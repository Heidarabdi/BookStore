...
<div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
    ...
    <form class="my-10" action="../controllers/conformPasswordController.php" method="POST" enctype="multipart/form-data">
        <div class="flex flex-col space-y-5">
<!--            password-->
            <label for="password">
                <p class="font-medium text-slate-700 pb-2">Password</p>
                <input required aria-required="true" id="password" name="password" type="password" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter password">
            </label>
            <!-- Confirm password -->
            <label for="confirm-password">
                <p class="font-medium text-slate-700 pb-2">Confirm Password</p>
                <input required aria-required="true" id="confirm-password" name="confirm-password" type="password" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Confirm Password">
            </label>
